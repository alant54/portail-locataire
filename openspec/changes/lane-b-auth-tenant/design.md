...
- **Balance rule**: start with all non-archived entries regardless of `status`; compare with the snapshot oracle in a test and adjust once (decision recorded in design when known).
